...
curl -H "Content-Type: application/json" -X POST \
  ...
  "http://localhost:5990/conversations/user123/trigger_intent?output_channel=latest"
```
...
"http://localhost:5990/conversations/user1234/trigger_intent?output_channel=latest"
```
