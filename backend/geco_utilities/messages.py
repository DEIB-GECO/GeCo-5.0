...
gmql_operations = 'Do you want to modify the extracted data using a GMQL operation?'
...
row_message = "You have to define what to put in the rows. Which region data do you want?"
not_understood = "Sorry, I didn't understand your choice."