...
start_init = "What do you want to do?"
...
gmql_operations = 'Do you want to modify the extracted data using GMQL operations?'
...
cover_message = "Ok. I will put the regions together.\nI need you to tell me the min, max and, optionally, the groupby.\nLet's begin with the min."
...
modify_metadata = "With the project, you can modify a metadatum or select a list of region data to keep and discard the others.\nDo you want to modify a metadatum? If so, which one?"
cover_not_understood = 'Sorry I didn\'t understand, choose a number or write any'
choose_max = 'Now please choose the maximum.'
groupby = 'Do you want to groupby? If so, provide a metadatum on which groupby.'
...
keep_meta = 'Ok. So with the project you can define which metadata you want to keep.\nPlease, tell me which ones you want.\nIf you want more, please separate them using ';'.'
...
keep_region = 'Ok. So with the project you can define which region data you want to keep.\nPlease, tell me which ones you want.\nIf you want more, please separate them using ';'.'
