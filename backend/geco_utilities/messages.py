...
name = "Please, tell me the name for your dataset."
...
region_filter = "You can also select only regions with specific conditions. Do you want to filter on regions?"
metadatum_choice = "Which metadatum do you want to filter on?\n You can see your choices in the right pane."
region_choice = "Which region do you want to filter on?\n You can see your choices in the right pane."
...
pivot_message = "Now I will put the data in a table, so as you can analyze them easily. This step can take some time, I'm sorry that you will wait."
row_meta_message = "You have to define what to put in the rows. Which metadatum do you want?"
row_region_message = "You have to define what to put in the rows. Which region do you want? You can find the possible choices on the right."
regions_not_available = "I'm sorry but this dataset does not have the region data yet. You can still download the links to retrieve them!"
column_meta_message = "You have to define what to put in the column. Which metadatum do you want?"
column_region_message = "You have to define what to put in the columns. Which region do you want? You can find the possible choices on the right."
value_region_message = "Which region data do you want to use to fill your table? You can find the possible choices on the right."
...
arithmetic_operation = 'Which operation do you want to do? You can choose among the ones in the right panel.'
...
kmeans = "Ok, I will perform K-Means clustering."
dbscan = "Ok, I will perform DBScan clustering."
only_clust = "Sorry, only clustering is implemented till now."
par_tuning_kmeans = "I will apply parameter tuning to decide the best number of clusters."
min_n_clust = "Which is the minimum number of clusters you want to try?"
max_n_clust = "Which is the maximum number of clusters you want to try?"
analysis_done = "Here there is your analysis results!"
restart = "You can restart from the beginning or close the page!"