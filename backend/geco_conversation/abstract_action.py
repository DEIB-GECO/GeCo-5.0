...
class AbstractAction(ABC):
    ...
    def run(self, message, intent, entities):
        if intent == "help":
            ...
            msg = [Utils.chat_message('Here in Milan the weather forecast says that it ' + json.loads(response.content.decode('utf-8'))['consolidated_weather'][0]['weather_state_name'].lower())]
            return msg, None, {}
        else:
