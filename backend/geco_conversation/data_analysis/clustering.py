...
class Clustering(AbstractAction):
    ...
    def on_enter(self):
        self.context.add_bot_msg(Utils.chat_message("Do you already know how many clusters to create? If so, tell me the number"))
        return None, False
    ...
    def logic(self, message, intent, entities):
        ...
        if intent != 'deny':
            ...
            self.context.add_bot_msg(Utils.chat_message("Ok, I will perform K-Means clustering using {}.".format(n_clust)))
